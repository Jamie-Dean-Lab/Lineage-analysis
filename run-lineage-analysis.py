...
def run_lineage_analysis(this_dir):
    return f"""date; echo "Hello Myriad"; julia -t 18 --project={this_dir} -e 'using Pkg; Pkg.instantiate(); include("{this_dir}/controlgetlineageABCdynamics.jl"); controlgetlineageABCdynamics()'; date"""
